...
wiki = {
    ...
    'Перчатки разбойника Второго': ["Ну тОЧНо ВтОрОГО.",
                                    ...
                                    'Броня'],
    'Книга заклинаний': ['КАкаЯ кНижкАа :З', ['Урон', 6], 'Орудие']
}
wiki_monsters = {
...
def menu(player):
    ...
    def choice_menu():
        ...
        while player_choice not in ['1','2','3']:
            player_choice = input("- ЧтО дЕлАТь БуДЕм? (1 - Инвентарь, 2 - Атака, 3 - Уклонение)\n")
        if player_choice == '1':
            inventory()
    def inventory():
        ...
        print(talk)
        player.show_all()
        player_inventory_choice = '2'
        while player_inventory_choice not in ['1', '2', '3']:
            player_inventory_choice = input("- ЧтО ТеПЕрЬ? (1 - Поглотить, 2 - Надеть, 3 - Ничего)\n")
